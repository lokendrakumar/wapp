 ...
 */
 app.get('/auth/login', function (req, res) {
   ...
   var velfieParam = _.isUndefined(req.query.fromv) ? null : req.query.fromv;
...
app.get('/auth/facebook', passport.authenticate('facebook',{
  scope :  ['manage_pages','publish_pages','publish_actions','public_profile','user_birthday'],
  display : 'popup'
}));
/**
...
app.get('/authentication', function (req, res) {
  ...
  var args = {
    pagename: 'welcome',
    partials: partials.authentication,
    title: 'Welcome'
  };
  res.render(partials.authentication.main, args);
});
